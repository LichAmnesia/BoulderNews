...
# @Date:   2016-04-19 22:11:26
# @Last Modified time: 2016-04-19 22:12:44
# @FileName: SendMail.py
# @Thanks for Filippo Cucchetto(filippocucchetto@gmail.com)
# @The origin of this code is from https://github.com/filcuc/SendMail/blob/master/SendMail.py
